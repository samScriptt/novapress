...
1. **Read Freely:** The platform is currently open. You can access all articles without a paywall.

2. **Interact:** Create a free account to comment, vote on articles, and submit feedback.
...
### 2. User System (Auth & Access)

* **Authentication:** Supabase Auth for user management.

* **Access Control:**  * **Visitors:** Read-only access to all content.

* **Logged Users:** Enabled to comment, vote (like/dislike), and participate in topic voting.
...
git clone [https://github.com/samScriptt/novapress.git](https://github.com/samScriptt/novapress.git)
