        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {posts?.map((post) => (
                <Link
                  href={`/post/${post.id}`}
                  key={post.id}
                  className="block bg-white dark:bg-green-900/5 border border-zinc-200 dark:border-green-900 p-4 hover:bg-zinc-50 dark:hover:bg-green-900/10 transition"
                >
                    <div className="text-[10px] text-zinc-400 dark:text-green-700 mb-2">
